...
let chooseyEndings = function(words, suffix){
  ...
  /*
  Check if words is an array; if not then return []
  else:
    filter array and use a method that checks the ending for ly; if ! ly then filter it out. Assign this to a new array.
  ...
  */
  ...
  filteredArray = words.filter(word => word.endsWith(suffix));
